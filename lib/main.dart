...
class KinematicFilter {
  ...
  void updateRealPosition(Position rawPos, {bool isWalkingMode = false}) {
    ...
    // Rafraîchit aussi immédiatement l'accéléromètre + applique la fusion
    // ici (utile si predictNextPosition n'a pas encore tourné ce cycle).
    _refreshAccelFusion();
